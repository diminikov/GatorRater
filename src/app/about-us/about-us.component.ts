...
export class AboutUsComponent {
  persons : AboutUs [] = [
    ...
    new AboutUs('Yonas', 'Hello, I am from Jax.', 'Front-End Development','assets/img/yonas.jpeg'), 
    new AboutUs('Nish', 'Hello, I am from Australia.', 'Back-End Development','assets/img/nish.jpeg'), 
    new AboutUs('Dimitri', 'Hello, I am from Gulf breeze Fl.', 'Front-End Development','assets/img/dimitri.jpeg' ) 
